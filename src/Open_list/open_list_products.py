...
class ButtonsMenuOpenListProducts(ctk.CTkFrame):
    """
    ...
    def __config_menu_buttons(self) -> None:
        ...
        self.__add_product.configure(command=self.add_button_click_handler)
        ...
        self.__filter_products.configure(command=self.filter_button_click_handler)
...
class ListProducts(ctk.CTk):
    ...
    def __config_scroll_frame(self) -> None:
        ...
        """
        self.__scroll_frame = ScrollOpenListProducts(self, width=wh_sf, height=ht_sf, fg_color=fgc_sf,corner_radius=cr_sf)
    ...
    def __config_menu_buttons(self) -> None:
        ...
        """
        self.__menu_btn = ButtonsMenuOpenListProducts(self, width=wh_mb, height=ht_mb, fg_color=fgc_mb, corner_radius=cr_mb)
        self.__menu_btn.place(relx=0, rely=0.6)


list_product = ListProducts()
list_product.mainloop()