...
class MainPage(ctk.CTk):
    ...
    def __config_menu_buttons(self) -> None:
        ...
        self.__my_lists.configure(command=self.all_lists_button_click_handler)
        ...
        self.__favorites.configure(command=self.favorites_button_click_handler)
        ...
        self.__history.configure(command=self.history_button_click_handler)
